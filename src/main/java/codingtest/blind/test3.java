...
public class test3 {
    ...
    public static void main(String[] args) {
        ...
        String[][] input;
        input = new String[][]{{"100", "ryan", "music", "2"}, {"200", "apeach", "math", "2"}, {"300", "tube", "computer", "3"}, {"400", "con", "computer", "4"}, {"500", "muzi", "music", "3"}, {"600", "apeach", "music", "2"}};
        solution(input);
    }
